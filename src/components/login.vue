  ...
  <div>
    ...
    <div class="container">
      <div class="bgImg">
        ...
        <!-- 注册操作区域 -->
        <div class="regInput" v-else-if="!show">
          <!-- 注册用户名 -->
...
export default {
  data() {
    return {
      ...
      uname: "",
      upass: "",
      yztimg: "http://zidan.applinzi.com/wechat/My_selected.png"
    };
  },
  methods: {
    xinname(){
    ...
    // 新用户注册
    reg(){
      this.axios.get("loginzhuce",{params:{uname:this.uname,upass:this.upass}}).then(result=>{
      ...
      this.axios
        ...
        .then(result => {
          ...
          if (result.data.msg == "登录成功") {
            ...
            this.uname = "";
            this.upass = "";
            this.yztimg = "http://zidan.applinzi.com/wechat/My_selected.png";
          }
        });
    },
...
.bgImg {
  height: 800px;
  background: url("http://zidan.applinzi.com/wechat/loginbg.jpg") repeat;
}
/* logo */
.imgDiv {
  padding-top: 150px;
